...
def generate_launch_description():
    ...
    gazebo = ExecuteProcess(
            cmd=['gazebo','--verbose', '-s', 'libgazebo_ros_init.so', '-s', 'libgazebo_ros_factory.so', os.path.join(get_package_share_directory(package_name), 'worlds', 'obstacle.world')], # Replace with your command and arguments
